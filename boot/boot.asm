...
OEMLabel		db "UNICORE "	; Disk label
...
LogicalSectors		dw 2400		; Number of logical sectors
MediumByte		db 0F9h		; Medium descriptor byte
SectorsPerFat		dw 9		; Sectors per FAT
SectorsPerTrack		dw 15		; Sectors per track (36/cylinder)
...
VolumeLabel		db "UNICORE 1.0"; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  SYS"	; Kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "KERNEL.SYS not found!", 0
